...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<canvas class="rflow-page-anim"></canvas>
...
<!-- 				<h1 class="blog-title">
 ...
 -->
				<h1 class="rflow-title-box">
					<div class="rflow-logo"></div>
					<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> &mdash; <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>" rel="home"><?php echo esc_attr( get_bloginfo( 'title' ) ); ?></a>
				</h1>
			...
			<ul class="main-menu">
			 ...
			 <div class="credits">
			 	...
			 	<p>&copy; <?php echo "2005-" . date("y") ?> <a href="<?php echo esc_url( home_url( '/' ) ); ?>">RECURSIVE FLOW</a></p>
